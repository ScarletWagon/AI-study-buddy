            ...
            const response = await fetch('/api/generate', {
                ...
                body: JSON.stringify({
                    prompt: chat.length === 0
                        ? `Provide a step-by-step explanation for the following problem: ${message}`
    ...
    return (
        <div className="feature-container chat-mode">
            ...
            <div className="chat-window">
                {chat.length === 0 && (
                    <div className="chat-placeholder">Ask your homework question to get started.</div>
                )}
                {chat.map((msg, idx) => (
                    <div
                        key={idx}
            ...
            <div className="chat-input-row">
                <textarea
                    ...
                    placeholder={chat.length === 0 ? 'Enter your homework problem...' : 'Ask a follow-up or request more detail...'}
                    disabled={loading}
                />
